...
class InspectTemporalMemory(TemporalMemory):
  """
  Stores a detailed history, for inspection and debugging.
  """

  def __init__(self, *args, **kwargs):
    super(InspectTemporalMemory, self).__init__(*args, **kwargs)
  ...
  def compute(self, activeColumns, learn=True):
    ...
    super(InspectTemporalMemory, self).compute(activeColumns, learn=True)
  ...
  def reset(self):
    ...
    super(InspectTemporalMemory, self).reset()
