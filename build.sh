...
function pythonSetup {
    ...
    PATH=$NUPIC_INSTALL:$PATH pip install -vvv --find-links=file://$NUPIC/external/common/pip-cache --no-index --index-url=file:///dev/null --install-option="--prefix=$NUPIC_INSTALL" --ignore-installed numpy==1.7.1
    exitOnError $?
