...
# Boosting related get/set() methods
  ...
  def getMinActiveDutyCycles(self, minActiveDutyCycles):
    ...
    self.boosting.getMinActiveDutyCycles(minActiveDutyCycles)
  ...
  def getActiveDutyCycles(self, activeDutyCycles):
    ...
    self.boosting.getActiveDutyCycles(activeDutyCycles)
  ...
  def getOverlapDutyCycles(self, overlapDutyCycles):
    ...
    size must match the number of columns"""
    self.boosting.getOverlapDutyCycles(overlapDutyCycles)
  ...
  def getMinOverlapDutyCycles(self, minOverlapDutyCycles):
    ...
    self.boosting.getMinOverlapDutyCycles(minOverlapDutyCycles)
...
# end of Boosting related get/set() methods
  ...
  def stripUnlearnedColumns(self, activeArray):
    ...
    """
    adc = numpy.zeros(activeArray.size)
    self.boosting.getActiveDutyCycles(adc)
    neverLearned = numpy.where(adc == 0)[0]
