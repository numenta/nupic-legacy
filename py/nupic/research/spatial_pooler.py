...
class SpatialPooler(object):
  ...
  public interface to this function is the "compute" method, which takes in an
  input vector and returns a list of activeColumns columns.
  ...
  # TODO: This should be __getstate__
  def __get_state__(self):
    if not hasattr(self,"_version"):
      pass
