...
class ClientJobsDAO(object):
  ...
  StreamMgr) make calls to this DAO to request new jobs (Swarm, stream
  ...
  filled in by swarm jobs with the results of each model that it
  evaluates.
  ...
  _eng_worker_conn_id (engWorkerConnId): database client connection ID of the
            swarm worker that is running this model
  ...
  _eng_stop (engStop): One of the STOP_REASON_XXX enumerated value strings
            ...
            if Swarm decides that the search is over and this model
    ...
    if 'jobs' not in tableNames:
      ...
      fields = [
        ...
        '_eng_job_type           VARCHAR(32)',
            ...
            # choices are swarm, production worker, or stream worker
        ...
        'gen_base_description    LONGTEXT',
            # The contents of the generated description.py file from swarm
            # requests. This is generated by the Swarm workers and stored
        ...
        'gen_permutations        LONGTEXT',
            ...
            # swarm requests. This is generated by the Swarm workers
        ...
        '_eng_worker_state       LONGTEXT',
            # JSON encoded state of the swarm in progress, for private
            # use by the Swarm workers
    ...
    if 'models' not in tableNames:
      ...
      fields = [
        ...
        'optimized_metric        FLOAT ',
            #Value of the particular metric we are optimizing in swarm
  ...
  def jobSuspend(self, jobID):
    ...
    it on Swarm jobs. For canceling any job type, use jobCancel() instead!
  ...
  def jobInsert(self, client, cmdLine, clientInfo='', clientKey='', params='',
    ...
    clients that wish to startup a new job, like a Swarm, stream job, or
  ...
  def modelSetCompleted(self, modelID, completionReason, completionMsg,
    ...
    useConnectionID:     True if the connection id of the calling function
                          ...
                          job. Set to True for swarm workers, which use
